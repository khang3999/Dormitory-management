<x-admin-layout>
    ...
    <div class="bang" id="donXinVao">
        <div class="tableName"> Sinh viên đã rời kí túc xá</div>
        <div class="row py-2">
            <div class="col-8">
            ...
            <table class="table table-bordered">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col" class="text-12">Vào</th>
                        <th scope="col" class="text-12">Ra</th>
                    ...
                    @else
                        @foreach ($students as $student)
                            <tr>
                                ...
                                <td class="text-12">{{ $student->timeout }}</td>
                                <td class="text-12">{{ $student->idphong }}</td>
                                <td class="text-15">
                                    <i class="bi bi-app"></i>
